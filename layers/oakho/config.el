...
(spacemacs|add-toggle fira-code
  :status fira-code-minor-mode
  :on (fira-code-minor-mode)
  :off (fira-code-minor-mode -1)
  :documentation "Toggle Oakho minor mode"
  :evil-leader "to")

(spacemacs|diminish fira-code-minor-mode " F" " f")

;; (add-hook 'text-mode-hook 'fira-code-mode t)
